...
export default function UnitPlanForm({ onSubmit }: Props) {
    ...
    <div className="grid grid-cols-2 gap-3">
      <div className="col-span-2">
        ...
        <input
          ...
          placeholder="e.g. Local environment and sustainability"
        />
      </div>
      <div>
      ...
      <div>
        ...
        >
          {["English", "Mathematics", "Science", "Social Sciences", "Technology", "The Arts", "Health and Physical Education"].map((la) => (
